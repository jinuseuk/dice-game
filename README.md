...
| 역할 | 기여 내용 | 성과 |
| :--- | :--- | :--- |
| **Back Ground Text 구현** | [cite_start]실시간 게임 정보(SCORE, 시간, 게임 상태, Player Turn 등)를 VGA 화면에 확대·정렬·테두리 처리하여 표시하는 기능 구현[cite: 421]. | [cite_start]픽셀 매핑 오류를 신호 흐름 점검 및 좌표 연산 수정을 통해 해결[cite: 422, 439]. VGA 화면 제어 기술 숙련. |
